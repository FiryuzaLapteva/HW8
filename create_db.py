import csv
def Create_db():
    with open('Pupils.csv', 'w', encoding='utf-8') as pupils:
    ...
    with open('Seats_status.csv', 'w', encoding='utf-8') as seats_status:
    ...
    with open('Seats.csv', 'w', encoding='utf-8') as seats:
